 ...
 */
@Entity
public class Picture implements Serializable, BookFilesInterface {
    ...
    public Picture(String description, String pathToFile, String url) {
    ...
    public String toString() {
        return "Picture{" + "id=" + id + ", description=" + description + ", pathToFile=" + pathToFile + ", url=" + url + '}';
    }
