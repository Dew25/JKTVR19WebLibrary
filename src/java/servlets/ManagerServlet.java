...
public class ManagerServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        switch (path) {
            case "/addBook":
                request.getRequestDispatcher(LoginServlet.page.getString("addBookPage")).forward(request, response);
                break;
            case "/createBook":
            ...
            case "/editBookForm":
                ...
                request.getRequestDispatcher(LoginServlet.page.getString("editBookPage")).forward(request, response);
                break;
            case "/editBook":
